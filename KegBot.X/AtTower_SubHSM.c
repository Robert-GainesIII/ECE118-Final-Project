        ...
        case RotateCCW:
            ...
            switch (ThisEvent.EventType) {
                case ES_ENTRY:
                    ...
                    //
                    ES_Timer_InitTimer(CCW_ADJUST_TIMER2, 450);   
             
                    //CCW ROTATE
                    LeftMtrSpeed(65, REVERSE);
        ...
        case RotateCW:
            ...
            switch (ThisEvent.EventType) {
                case ES_ENTRY:
                    ...
                    ES_Timer_InitTimer(CCW_ADJUST_TIMER2, 400);
...
//                    break;
        ...
        case Reverse:
            ...
            switch (ThisEvent.EventType) {
                case ES_ENTRY:
                    //Reverse
                    ES_Timer_InitTimer(REVERSE_TIMER1, 350);
        ...
        case SharpTurn:
            ...
            switch (ThisEvent.EventType) {
                case ES_ENTRY:
                    ...
                    ES_Timer_InitTimer(TURN_TIMER, 550
                            );
