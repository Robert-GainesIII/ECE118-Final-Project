...
static RotateAroundTowerState_t CurrentState = InitPSubState; // <- change name to match ENUM
...
uint8_t InitRotateAroundTowerSubHSM(void) {
    ES_Event returnEvent;

    CurrentState = InitPSubState;
    returnEvent = RunRotateAroundTowerHSM(INIT_EVENT);
...
ES_Event RunRotateAroundTowerHSM(ES_Event ThisEvent) {
    uint8_t makeTransition = FALSE; // use to flag transition
    RotateAroundTowerState_t nextState; // <- change type to correct enum

    static int traverseDirection = CCW;
    ...
    switch (CurrentState) {
        ...
        case RotateCW:
            ...
            switch (ThisEvent.EventType) {
                case ES_ENTRY:
                    ...
                    //
                    ES_Timer_InitTimer(CCW_ADJUST_TIMER2, 300);
        ...
        case RotateCCW:
            ...
            switch (ThisEvent.EventType) {
                case ES_ENTRY:
                    ...
                    ES_Timer_InitTimer(CCW_ADJUST_TIMER2, 500);
        ...
        case SharpTurn:
            ...
            switch (ThisEvent.EventType) {
                ...
                case BACK_R_BUMP:
                    printf("This should be happening");
                    StopMotors();
                    nextState = Reverse;
                    makeTransition = TRUE;
                    ThisEvent.EventType = ES_NO_EVENT;
...
//                    // ONCE BACK RIGHT BUMP IS DETECTED BOT WILL DRIVE FORWARD
//                    //UNTIL FRONT RIGHT BUMPER IS LOST, THERE IT WILL BANK TURN
//                    //FORWARD UNTIL BOTH RIGHT BUMPERS RE CONNECTED
//                    nextState = Reverse;
//                    makeTransition = TRUE;
//                    StopMotors();
//                    ThisEvent.EventType = ES_NO_EVENT;
//                    break;
    ...
    if (makeTransition == TRUE) { // making a state transition, send EXIT and ENTRY
        ...
        RunRotateAroundTowerHSM(EXIT_EVENT); // <- rename to your own Run function
        CurrentState = nextState;
        RunRotateAroundTowerHSM(ENTRY_EVENT); // <- rename to your own Run function
    }
